...
<p><strong>Cinematic manifesto with pinned horizontal scroll.</strong></p>

<p>
  <a href="https://bswxyz.github.io/formwork-award/"><img alt="Live demo" src="https://img.shields.io/badge/demo-live-8b5cf6?style=flat-square&labelColor=1a1a1a"></a>
...
<p>
  <a href="https://bswxyz.github.io/formwork-award/"><b>Live demo</b></a>
  &nbsp;·&nbsp;
  <a href="https://bswxyz.github.io/formwork-award/guide/">Build notes</a>
  &nbsp;·&nbsp;
  <a href="https://parable-three.vercel.app/templates">More templates</a>
</p>

<a href="https://bswxyz.github.io/formwork-award/">
  <img src=".github/preview.jpg" alt="Award — live preview" width="100%">
</a>
...
```bash
npx degit bswxyz/formwork-award my-app
```


**Live demo → https://bswxyz.github.io/formwork-award/** · [How it was built](https://bswxyz.github.io/formwork-award/guide/)
...
```bash
gh repo create my-site --template bswxyz/formwork-award --public --clone
cd my-site
